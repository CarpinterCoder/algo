...
public class ValidNumber {
	...
	public static void main(String[] args){
		...
		System.out.println(isNumber("-1.0"));
		System.out.println(isNumber("000123"));
		System.out.println(isNumber(" 000.123"));
		System.out.println(isNumber("0001.23"));
		System.out.println(isNumber("000123e(10)"));
		System.out.println(isNumber(".000123"));
		System.out.println(isNumber(".e00123"));
		System.out.println(isNumber("-.000125"));
		System.out.println("125e".toUpperCase());
	}
}
